...
Prerequisites: steps below assume that you have the
[latest LTS version of NodeJS](https://nodejs.org/en/download/) installed.
...
- **Stories** - stories live in a subdirectory inside `/stories` with the same
  name as the custom element. Ex: `/stories/gdwc-menu`
